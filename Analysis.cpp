...
void analysis(Root_file_handler * input_root_file, Root_file_handler * output_root_file, histo_handler * Hist, config_file_reader * config_file, __int64 num_events){
	...
	for(__int64 idx=0;idx<num_events;idx++){
		...
		//char * sub_name = "Basic";
		//int num = 0;
		//Hist->fill2(1,"pipico1 spectrum ",event->rtof[0],event->rtof[1],"PIPICO spectrum " ,750,0.,6000.,"rec1 TOF [ns]",750,0.,6000.,"rec2 TOF [ns]",sub_name);
		//Hist->fill1(2," tof hit 1 ",event->rtof[0],"r1tof ",500,0.,5000.,"rec1 TOF [ns]",sub_name);
		//Hist->fill1(3," tof hit 2 ",event->rtof[1],"r2tof ",500,0.,5000.,"rec2 TOF [ns]",sub_name);
		//Hist->fill1(4,"e1_tof",event->etof[0],"e1_tof",500,-10.,350.,"e1tof [ns]",sub_name);
		//Hist->fill1(5,"e2_tof",event->etof[1],"e2_tof",500,-10.,350.,"e1tof [ns]",sub_name);
		//Hist->fill2(6,"e1 X fish",event->etof[0],event->ex[0],"e1 X fish",500,-10.,100.,"e1tof [ns]",500,-50.,50.,"e1z [mm]",sub_name);
		//Hist->fill2(7,"e1 Y fish",event->etof[0],event->ey[0],"e1 Y fish",500,-10.,100.,"e1tof [ns]",500,-50.,50.,"e1y [mm]",sub_name);
		//Hist->fill2(8,"e2 X fish",event->etof[1],event->ex[1],"e2 X fish",500,-10.,100.,"e2tof [ns]",500,-50.,50.,"e2z [mm]",sub_name);
		//Hist->fill2(9,"e2 Y fish",event->etof[1],event->ey[1],"e2 Y fish",500,-10.,100.,"e2tof [ns]",500,-50.,50.,"e2y [mm]",sub_name);
		//Hist->fill2(11,"e1 Wiggles",event->etof[0],sqrt(event->ex[0]*event->ex[0] + event->ey[0]*event->ey[0]),"e1 Wiggles",500,-10.,150.,"e1tof [ns]",500,0.,50.,"Radius [mm]",sub_name);
		//Hist->fill2(12,"e2 Wiggles",event->etof[1],sqrt(event->ex[1]*event->ex[1] + event->ey[1]*event->ey[1]),"e2 Wiggles",500,-10.,150.,"e2tof [ns]",500,0.,50.,"Radius [mm]",sub_name);
		//Hist->fill2(13,"r1x vs r1y",event->rx[0],event->ry[0],"Recoil Position",500,-75.,75.,"r1z [mm]",500,-75.,75.,"r1y [mm]",sub_name);
		//Hist->fill2(14,"r2x vs r2y",event->rx[1],event->ry[1],"Recoil Position",500,-75.,75.,"r2z [mm]",500,-75.,75.,"r2y [mm]",sub_name);
		//Hist->fill2(15,"e1z vs e1y",event->ex[0],event->ey[0],"Recoil Position",500,-50.,50.,"e1z [mm]",500,-50.,50.,"e1y [mm]",sub_name);
		//Hist->fill2(16,"e2x vs e2y",event->ex[1],event->ey[1],"Recoil Position",500,-75.,75.,"e2z [mm]",500,-75.,75.,"e2y [mm]",sub_name);
		//Hist->fill1(17," r1y " ,event->ry[0],"r1y ",500,-70.,70.,"rec1 y [mm]",sub_name);
		//Hist->fill1(18," r1x " ,event->rx[0],"r1z ",500,-70.,70.,"rec1 z [mm]",sub_name);
		//Hist->fill1(19,"reaction",event->reaction,"Reaction Flag",400,-1.,15.,"Reaction Number",sub_name);

		////gated to be in the center of y (low y momentum)
		//if( fabs(event->ey[0]) <= 5. ){
		//	Hist->fill2(20,"e1 X fish ygated",event->etof[0],event->ex[0],"e1 X fish ygated",150,30.,85.,"e1tof [ns]",150,-50.,50.,"e1z [mm]",sub_name);
		//}
		////gated to be in the center of z (low z momentum)
		//if( fabs(event->ex[0]) <= 5. ){
		//	Hist->fill2(21,"e1 Y fish zgated",event->etof[0],event->ey[0],"e1 Y fish zgated",150,30.,85.,"e1tof [ns]",150,-50.,50.,"e1y [mm]",sub_name);
		//}

		//Hist->fill2(22,"r1 X fish",event->rtof[0],event->rx[0],"r1 X fish",500,-10.,8000.,"r1tof [ns]",500,-70.,70.,"r1z [mm]",sub_name);
		//Hist->fill2(23,"r1 Y fish",event->rtof[0],event->ry[0],"r1 Y fish",500,-10.,8000.,"r1tof [ns]",500,-70.,70.,"r1y [mm]",sub_name);
...
//Hist->fill1(1101,"ehit_ntuple0",event->ehit,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
//Hist->fill1(1102,"ehit_ntuple1",event->ehit,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
//Hist->fill1(1103,"ehit_ntuple2",event->ehit,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
//Hist->fill1(1104,"ehit_ntuple3",event->ehit,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
//Hist->fill1(1105,"ehit_ntuple4",event->ehit,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
//Hist->fill1(1106,"ehit_ntuple5",event->ehit,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
//Hist->fill1(1107,"ehit_ntuple6",event->ehit,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
//Hist->fill1(1108,"ehit_ntuple7",event->ehit,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
//Hist->fill1(1109,"ehit_ntuple8",event->ehit,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
//Hist->fill1(1110,"ehit_ntuple9",event->ehit,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
//Hist->fill2(1111,"elec1xy_ntuple0",event->ex[0],event->ey[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
//Hist->fill2(1112,"elec1xy_ntuple1",event->ex[0],event->ey[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
//Hist->fill2(1113,"elec1xy_ntuple2",event->ex[0],event->ey[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
//Hist->fill2(1114,"elec1xy_ntuple3",event->ex[0],event->ey[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
//Hist->fill2(1115,"elec1xy_ntuple4",event->ex[0],event->ey[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
//Hist->fill2(1116,"elec1xy_ntuple5",event->ex[0],event->ey[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
//Hist->fill2(1117,"elec1xy_ntuple6",event->ex[0],event->ey[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
//Hist->fill2(1118,"elec1xy_ntuple7",event->ex[0],event->ey[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
//Hist->fill2(1119,"elec1xy_ntuple8",event->ex[0],event->ey[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
//Hist->fill2(1120,"elec1xy_ntuple9",event->ex[0],event->ey[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
//		
//Hist->fill1(1201,"ehit_ntuple10",event->ehit,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
//Hist->fill1(1202,"ehit_ntuple11",event->ehit,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
//Hist->fill1(1203,"ehit_ntuple12",event->ehit,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
//Hist->fill1(1204,"ehit_ntuple13",event->ehit,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
//Hist->fill1(1205,"ehit_ntuple14",event->ehit,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
//Hist->fill1(1206,"ehit_ntuple15",event->ehit,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
//Hist->fill1(1207,"ehit_ntuple16",event->ehit,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
//Hist->fill1(1208,"ehit_ntuple17",event->ehit,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
//Hist->fill1(1209,"ehit_ntuple18",event->ehit,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
//Hist->fill1(1210,"ehit_ntuple19",event->ehit,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
//Hist->fill2(1211,"elec1xy_ntuple10",event->ex[0],event->ey[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
//Hist->fill2(1212,"elec1xy_ntuple11",event->ex[0],event->ey[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
//Hist->fill2(1213,"elec1xy_ntuple12",event->ex[0],event->ey[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
//Hist->fill2(1214,"elec1xy_ntuple13",event->ex[0],event->ey[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
//Hist->fill2(1215,"elec1xy_ntuple14",event->ex[0],event->ey[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
//Hist->fill2(1216,"elec1xy_ntuple15",event->ex[0],event->ey[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
//Hist->fill2(1217,"elec1xy_ntuple16",event->ex[0],event->ey[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
//Hist->fill2(1218,"elec1xy_ntuple17",event->ex[0],event->ey[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
//Hist->fill2(1219,"elec1xy_ntuple18",event->ex[0],event->ey[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
//Hist->fill2(1220,"elec1xy_ntuple19",event->ex[0],event->ey[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
//		
//Hist->fill1(1301,"ehit_ntuple20",event->ehit,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
//Hist->fill1(1302,"ehit_ntuple21",event->ehit,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
//Hist->fill1(1303,"ehit_ntuple22",event->ehit,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
//Hist->fill1(1304,"ehit_ntuple23",event->ehit,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
//Hist->fill1(1305,"ehit_ntuple24",event->ehit,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
//Hist->fill1(1306,"ehit_ntuple25",event->ehit,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
//Hist->fill1(1307,"ehit_ntuple26",event->ehit,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
//Hist->fill1(1308,"ehit_ntuple27",event->ehit,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
//Hist->fill1(1309,"ehit_ntuple28",event->ehit,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
//Hist->fill1(1310,"ehit_ntuple29",event->ehit,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
//Hist->fill2(1311,"elec1xy_ntuple20",event->ex[0],event->ey[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
//Hist->fill2(1312,"elec1xy_ntuple21",event->ex[0],event->ey[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
//Hist->fill2(1313,"elec1xy_ntuple22",event->ex[0],event->ey[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
//Hist->fill2(1314,"elec1xy_ntuple23",event->ex[0],event->ey[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
//Hist->fill2(1315,"elec1xy_ntuple24",event->ex[0],event->ey[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
//Hist->fill2(1316,"elec1xy_ntuple25",event->ex[0],event->ey[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
//Hist->fill2(1317,"elec1xy_ntuple26",event->ex[0],event->ey[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
//Hist->fill2(1318,"elec1xy_ntuple27",event->ex[0],event->ey[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
//Hist->fill2(1319,"elec1xy_ntuple28",event->ex[0],event->ey[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
//Hist->fill2(1320,"elec1xy_ntuple29",event->ex[0],event->ey[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
//		
//Hist->fill1(1401,"ehit_ntuple30",event->ehit,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
//Hist->fill1(1402,"ehit_ntuple31",event->ehit,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
//Hist->fill1(1403,"ehit_ntuple32",event->ehit,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
//Hist->fill1(1404,"ehit_ntuple33",event->ehit,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
//Hist->fill1(1405,"ehit_ntuple34",event->ehit,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
//Hist->fill1(1406,"ehit_ntuple35",event->ehit,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
//Hist->fill1(1407,"ehit_ntuple36",event->ehit,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
//Hist->fill1(1408,"ehit_ntuple37",event->ehit,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
//Hist->fill1(1409,"ehit_ntuple38",event->ehit,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
//Hist->fill1(1410,"ehit_ntuple39",event->ehit,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
//Hist->fill2(1411,"elec1xy_ntuple30",event->ex[0],event->ey[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
//Hist->fill2(1412,"elec1xy_ntuple31",event->ex[0],event->ey[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
//Hist->fill2(1413,"elec1xy_ntuple32",event->ex[0],event->ey[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
//Hist->fill2(1414,"elec1xy_ntuple33",event->ex[0],event->ey[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
//Hist->fill2(1415,"elec1xy_ntuple34",event->ex[0],event->ey[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
//Hist->fill2(1416,"elec1xy_ntuple35",event->ex[0],event->ey[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
//Hist->fill2(1417,"elec1xy_ntuple36",event->ex[0],event->ey[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
//Hist->fill2(1418,"elec1xy_ntuple37",event->ex[0],event->ey[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
//Hist->fill2(1419,"elec1xy_ntuple38",event->ex[0],event->ey[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
//Hist->fill2(1420,"elec1xy_ntuple39",event->ex[0],event->ey[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
